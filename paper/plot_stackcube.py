...
df = pd.read_csv("wandb_stackcube.csv")
...
plot_metric("eval/success_once",  "fig_stackcube",              "Eval Success Once",   "Eval Success Rate")
plot_metric("eval/success_at_end","fig_stackcube_success_end",  "Eval Success at End", "Eval Success Rate")
plot_metric("eval/return",        "fig_stackcube_eval_return",  "Eval Return",         "Evaluation Return")
plot_metric("train/return",       "fig_stackcube_train_return", "Train Return",        "Training Return")
plot_metric("train/success_once", "fig_stackcube_train_success","Train Success Once",  "Training Success Rate")
